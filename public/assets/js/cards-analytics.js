...
! function() {
    let o, e, s, n, l;
    l = (isDarkStyle ? (o = config.colors_dark.cardColor, n = config.colors_dark.textMuted, s = config.colors_dark.bodyColor, e = config.colors_dark.headingColor, config.colors_dark) : (o = config.colors.cardColor, n = config.colors.textMuted, s = config.colors.bodyColor, e = config.colors.headingColor, config.colors)).borderColor;
    var t = {
            donut: {
        ...
        r = (null !== r && new ApexCharts(r, a).render(), document.querySelector("#supportTracker")),
        a = {
            series: [85],
        ...
        r = (null !== r && new ApexCharts(r, a).render(), document.querySelector("#salesLastMonth")),
        a = {
            series: [{
                name: "Sales",
        ...
        r = (null !== r && new ApexCharts(r, a).render(), document.querySelector("#totalRevenueChart")),
        a = {
            series: [{
                name: "Earning",
        ...
        r = (null !== r && new ApexCharts(r, a).render(), document.querySelector("#budgetChart")),
        a = {
            chart: {
                height: 100,
                toolbar: {
        ...
        r = (null !== r && new ApexCharts(r, a).render(), document.querySelector("#projectStatusChart")),
        a = {
            chart: {
                height: 252,
                type: "area",
    ...
    var r = $.ajax({
        ...
        a = (null !== a && new ApexCharts(a, c).render(), document.querySelector("#earningReportsTabsSales")),
        c = i(r.data[1].chart_data, r.data[1].active_option),
        a = (null !== a && new ApexCharts(a, c).render(), document.querySelector("#earningReportsTabsProfit")),
        c = i(r.data[2].chart_data, r.data[2].active_option),
        a = (null !== a && new ApexCharts(a, c).render(), document.querySelector("#earningReportsTabsIncome")),
        c = i(r.data[3].chart_data, r.data[3].active_option),
        r = (null !== a && new ApexCharts(a, c).render(), document.querySelector("#totalEarningChart")),
        a = {
            series: [{
                name: "Earning",
    ...
    c = document.querySelector("#carrierPerformance"), r = {
    ...
    }, null !== c && new ApexCharts(c, r).render(), a = document.querySelector("#deliveryExceptionsChart"), c = {
        chart: {
            height: 400,
            parentHeightOffset: 0,
            type: "donut"
        ...
        series: [13, 25, 22, 40],
        colors: [t.donut.series1, t.donut.series2, t.donut.series3, t.donut.series4],
        stroke: {
            width: 0
        },
        dataLabels: {
