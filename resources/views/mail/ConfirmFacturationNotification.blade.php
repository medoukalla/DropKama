                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 26px; line-height: 36.4px; font-family: 'Montserrat', sans-serif;"><strong><span
                                                                                style="line-height: 36.4px; font-size: 26px;">Confirmer
                                            ...
                                            <table style="font-family:'Montserrat',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 40px 30px;font-family:'Montserrat',sans-serif;"
                                                            align="left">

                                                            <div
                                                                style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 16px; line-height: 22.4px;">Vous
                                                                        avez initié le paiement pour une commande, voici
                                                                        le code de confirmation de vos informations de
                                                                        facturation:</span></p>
                                                            </div>
                        ...
                        <div class="u-row"
                            ...
                            <div
                                ...
                                <div class="u-col u-col-100"
                                    style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                                    <div
                                        style="background-color: #232323;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 40px;font-family:'Montserrat',sans-serif;"
                                                            ...
                                                            <div
                                                                style="line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 38px; line-height: 53.2px;"><strong><span
                                                                                style="line-height: 53.2px; font-size: 38px;">{{ $code }}</span></strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Montserrat',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 40px 15px;font-family:'Montserrat',sans-serif;"
                                                            align="left">

                                                            <div
                                                                style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 16px; line-height: 22.4px;">Ce
                                                                        code de vérification expirera après 5 minutes,
                                                                        si c'est le cas, demandez-en un autre.</span>
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        ...
                                                                        email a été envoyé à: <span
                                                                            style="color: #f48500; font-size: 10px; line-height: 14px;">{{ $user_email }}</span>
