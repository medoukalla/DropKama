                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 40px;font-family:'Montserrat',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        ...
                                                                        on attend le paiement pour la commande
                                                                        <strong>{{ $reference }}</strong>.</span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;"> </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 16px; line-height: 22.4px;">Dès
                                                                        que le paiement est effectué, un agent vous
                                                                        contactera sous peu, sinon vous pouvez cliquer
                                                                        sur le lien ci-dessous pour finaliser votre
                                                                        paiement.</span></p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 40px;font-family:'Montserrat',sans-serif;"
                                                            ...
                                                            <div align="center">
                                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://dropkamas.com/" style="height:49px; v-text-anchor:middle; width:260px;" arcsize="0%"  stroke="f" fillcolor="#f48500"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Montserrat',sans-serif;"><![endif]-->
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:15px 40px;line-height:120%;"><span
                                                                            style="font-size: 16px; line-height: 19.2px;"><strong><span
                                                                                    style="line-height: 19.2px; font-family: 'Montserrat', sans-serif; font-size: 16px;">Suivez
                                                                                    votre commande</span></strong>
                                                                        </span>
                                                                    </span>
                                                                </a>
