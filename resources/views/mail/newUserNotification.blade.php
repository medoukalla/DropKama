                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 26px; line-height: 36.4px; font-family: 'Montserrat', sans-serif;"><strong><span
                                                                                style="line-height: 36.4px; font-size: 26px;">Bienvenue,
                                                                                <span
                                                                                    style="color: #f48500; font-size: 26px; line-height: 36.4px;">{{ $username }}</span>
                                                                                👋<br /></span>
                                                                        </strong>
                                                                    </span>
                                                                </p>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 40px;font-family:'Montserrat',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 16px; line-height: 22.4px; font-family: 'Montserrat', sans-serif;">Merci
                                                                        d'avoir choisi DropKamas, votre inscription est
                                                                        bien enregistrée !</span></p>
                                                                <p style="font-size: 14px; line-height: 140%;"> </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 16px; line-height: 22.4px; font-family: 'Montserrat', sans-serif;">Vous
                                                                        êtes désormais membre et vous pouvez en profiter
                                                                        de la totalité des services de DropKamas.</span>
                                                                </p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 40px;font-family:'Montserrat',sans-serif;"
                                                            ...
                                                            <div align="center">
                                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://dropkamas.com/" style="height:49px; v-text-anchor:middle; width:191px;" arcsize="0%"  stroke="f" fillcolor="#f48500"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Montserrat',sans-serif;"><![endif]-->
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:15px 40px;line-height:120%;"><span
                                                                            style="font-size: 16px; line-height: 19.2px;"><strong><span
                                                                                    style="line-height: 19.2px; font-family: 'Montserrat', sans-serif; font-size: 16px;">Je
                                                                                    découvre !</span></strong>
                                                                        </span>
                                                                    </span>
                                                                </a>
