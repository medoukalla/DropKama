                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 40px;font-family:'Montserrat',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        ...
                                                                        nous n'avons pas reçu votre paiement pour la
                                                                        commande <strong>{{ $reference }}</strong>,
                                                                        elle a donc été annulée automatiquement, vous
                                                                        pouvez toujours passer une nouvelle commande à
                                                                        tout moment ou contacter notre support pour
                                                                        obtenir de l'aide.</span>
                                                                </p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 40px;font-family:'Montserrat',sans-serif;"
                                                            ...
                                                            <div align="center">
                                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://dropkamas.com/acheter" style="height:49px; v-text-anchor:middle; width:276px;" arcsize="0%"  stroke="f" fillcolor="#f48500"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Montserrat',sans-serif;"><![endif]-->
                                                                <a href="https://dropkamas.com/acheter" target="_blank"
                                                                    class="v-button"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:15px 40px;line-height:120%;"><span
                                                                            style="font-size: 16px; line-height: 19.2px;"><strong><span
                                                                                    style="line-height: 19.2px; font-family: 'Montserrat', sans-serif; font-size: 16px;">Commander
                                                                                    à nouveau</span></strong>
                                                                        </span>
                                                                    </span>
                                                                </a>
