...
<body>
  <div class="error-page">
    ...
    <div class="error-type">419 - Expiration de l'Authentification</div>
    <div class="error-msg">
        Nous sommes désolés, mais votre session a expiré. Veuillez vous reconnecter. Si le problème persiste, veuillez contacter le support.
