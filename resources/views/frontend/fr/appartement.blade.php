<x-fr.head title="{{ setting('site.title') . ' - ' . $appartement->title }}" />
...
<div class="wrapper bg-dark">
    <div class="QuiSommes">
        <div class="container">
            <p class="text-center">
                <a href="{{ route('frontend.index') }}">bienvenue</a>
                <img src="{{ asset('img/arrowRgiht.svg') }}" alt="img" class="img-fluid" />

                <a href="{{ route('frontend.logements') }}">Logements</a>
                <img src="{{ asset('img/arrowRgiht.svg') }}" alt="img" class="img-fluid" />
                        ...
                        <div class="itemLeft08">
                            ...
                            <div class="detailsDe">
                                ...
                                <div class="itemDetails">
                                    <h2>information générale sur l'appartement</h2>
                                    <div class=" d-flex justify-content-between flex-wrap align-items-center">
                                        <div class="room-item item03 mb-4">
                                            <div class="g-item d-flex align-item-center gap-1">
                                        ...
                                        <div class="room-item item03 mb-4">
                                            <div class="g-item d-flex align-item-center gap-1">
                                                <img src="{{ asset('img/price.svg') }}" alt="price">
                                                <p>Prix</p>
                                            </div>
                                            <h4>{{ $appartement->first_payment + $appartement->Frais_service }}€ /mois
                                            </h4>
                                        </div>

                                        <div class="room-item item03 mb-4  mt-sm-0 mt-3">
                                            <div class="g-item d-flex align-item-center gap-1">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            @if ($appartement->option_towels_linen == true)
                                                <div class="col-6 col-md-3 px-0 text-center mb-4">
                                                    <p>Serviettes et linge de lit</p>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            @foreach ( $rules as $rule)
                                                <div class="col-6 col-md-4 px-0 text-center mb-4 @if ($rule->status == 0) optionInactive @endif ">
                                                    <p>{{ $rule->rule }}</p>
                                                    {!! $rule->item->svg_code !!}
                                                </div>
                                            @endforeach
                                ...
                                <div class="itemDetails app-conditions">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            @foreach ( $conditions as $key => $condition )
                                                <div class="col-6 col-md-6 px-0 text-center mb-4">
                                                    <button class="bg-transparent border-0" role="button"
                                                        ...
                                                        href="#collapseCondition{{$key}}" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseCondition{{$key}}" aria-expanded="false"
                                            ...
                                            <div class="col-12">
                                                @foreach ( $conditions as $key => $condition )
                                                    <div class="collapse mt-2" id="collapseCondition{{$key}}">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ( $contracts as $key => $contract )
                                                <div class="col-6 col-md-6 px-0 text-center mb-4">
                                                    <button class="bg-transparent border-0" role="button"
                                                        onclick="$('.collapse.show').removeClass('show')"
                                                        href="#collapseContract{{$key}}" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseContract{{$key}}" aria-expanded="false"
                                            ...
                                            <div class="col-12">
                                                @foreach ( $contracts as $key => $contract )
                                                    <div class="collapse mt-2" id="collapseContract{{$key}}">
                                                        <div class="cnt-conditions card card-body">
                                                            {!! $contract->content !!}
                                                        </div>
                                                    </div>
                                ...
                                <div class="why-choice-us">
                                    <h4>Pourquoi choisir immiworld ?</h4>
                                            ...
                                            <div class="swiper-wrapper" id="swiperWrapper">
                                                ...
                                                <div
                                                    ...
                                                    <div class="top">
                                                        ...
                                                        <div class="title">Louer sans tracas</div>
                                                    </div>
                                                    <p class="mt-2">
                                                        Oubliez les appels ennuyeux, les processus de sélection ou les
                                                        garants sur presque toutes les propriétés... avec Uniplaces,
                                                        vous trouverez ce que vous cherchez, en trouvant un nouveau
                                                        logement, où que vous soyez dans le monde !
                                                    </p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="top">
                                                        ...
                                                        <div class="title">Protection contre la fraude</div>
                                                    </div>
                                                    <p class="mt-2">
                                                        Le logement que vous avez réservé sur Uniplaces n'est pas le
                                                        même que celui que vous venez d'emménager ? Faites-le nous
                                                        savoir dans les 24 heures suivant votre date d'emménagement et
                                                        profitez de notre Protection Locataire. Nous effectuerons le
                                                        paiement au propriétaire seulement 24 heures après votre
                                                        emménagement et trouverons un moyen de vous aider.
                                                    </p>
                                                </div>
                                                <!-- When you move in -->
                                                <div
                                                    ...
                                                    <div class="top">
                                                        ...
                                                        <div class="title">Certificat d'hébergement pour visa</div>
                                                    </div>
                                                    <p class="mt-2">
                                                        Avez-vous besoin d'un document prouvant que vous disposez d'un
                                                        logement pour demander un visa ? Nous pouvons vous fournir une
                                                        attestation d'hébergement prépayée pour vous aider dans votre
                                                        demande de VISA.
                                                    </p>
                                                </div>
                                                <!-- When you move out -->
                                                <div
                                                    ...
                                                    <div class="top">
                                                        ...
                                                        <div class="title">Plusieurs demandes, payez-en une seule.
                                                        </div>
                                                    </div>
                                                    <p class="mt-2">
                                                        Augmentez vos chances qu'une demande soit acceptée en envoyant
                                                        des demandes de réservation pour plusieurs propriétés. Seule la
                                                        première réservation acceptée vous sera facturée, tandis que
                                                        toutes les autres demandes seront automatiquement annulées.
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                <!-- par ce logement start  -->
                                <div class="parCeLogement">
                                    <a href="{{ route('frontend.checkout', $appartement->id) }}"
                                        class="main-btn text-center d-block w-100">
                                        Checkout
                                    </a>
                                </div>
                                <!-- par ce logement end -->
