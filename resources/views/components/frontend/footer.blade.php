        ...
        <div class="col-12 col-md-4">
          <div class="logo-col">
            ...
            <data class="input d-flex position-relative">
              ...
              />
              <img
                src="{{ asset('frontend/images/svg/email-arr') }}ow-footer.svg"
                alt="Email arrow footer"
              />
            </data>
          </div>
        </div>
      ...
      <div class="row mt-5">
        <div class="col-12 col-md-4">
          ...
          <div class="payment-box">
            ...
            <img
              src="{{ asset('frontend/images/payments/mastercard.svg') }}"
              alt="mastercard"
            />
            <img
              src="{{ asset('frontend/images/payments/bancontact.svg') }}"
              alt="bancontact"
            />
