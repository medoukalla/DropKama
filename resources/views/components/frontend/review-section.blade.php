...
<section class="review-section">
    <div class="container">
      ...
      <div
        class="trustpilot d-flex align-items-center justify-content-center gap-3"
      >
        <p class="t-head">Trustpilot</p>
        <img
          src="{{ asset('frontend/images/svg/trustpilot-icon.svg') }}"
          alt="Trustpilot icon"
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <p class="review-content">
              Excellent site pour acheter des kamas ! Processus rapide,
              sécurisé et simple. Livraison rapide après paiement. Très
              satisfait du service !
            </p>
            <div class="quote-profile d-flex align-items-center gap-2">
              <div class="profile-box">
                <img src="{{ asset('frontend/images/profile-1.png') }}" alt="profile" />
              </div>
              <div class="profile-name">Fendyaa la</div>
            </div>
          </div>
          <!-- Slide -->
          <div class="swiper-slide">
