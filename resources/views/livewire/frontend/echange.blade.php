    ...
    <div class="row">
      <div class="col-12 col-md-6">
        <div class="kamas-settings w-100">
          ...
          @auth
              <div wire:loading.remove wire:click="save_echange()" class="main-btn mt-3 py-4" style="cursor: pointer;" >Échangez la demande</div>
              <div wire:loading wire:target="save_echange" class="main-btn mt-3 py-4 w-100" style="cursor: pointer;" >Échangez la demande</div>
          @endauth
          @guest
                ...
                <div class="echnage-infos-side sticky-top">
                    <div class="echnage-infos">
                        ...
                        <div class="info-danger">
                            ...
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsa recusandae dolore sequi illo
                            laudantium aliquam?
                        </div>
                    </div>
