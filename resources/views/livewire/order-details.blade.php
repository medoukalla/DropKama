    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-md-6 d-flex flex-column">
          ...
          <div class="bg-component-white mb-3 @if ( $order->payed == true && $order->payment_verified == false ) @else lock-step @endif">
          ...
          <!-- Question -->
          <div class="bg-component-white mb-3 @if ( $order->payed == true && $order->payment_verified == false ) @else d-none @endif">
          ...
          <div class="step-heading bg-component-white mb-3 @if ( $order->payment_verified == true && $order->facturer == false ) @else lock-step @endif">
            <div class="d-flex align-items-center justify-content-center gap-3">
          ...
          <div class="step-inputs bg-component-white mb-3 kamas-settings w-100 @if ( $order->payment_verified == true && $order->facturer == false ) @else d-none @endif">
            ...
            <div class="input mt-0 @if ( $facturation_steps > 2 ) d-none @endif">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <input wire:model.defer="email" type="email" id="normalInput" value="youssef@gmail.com" disabled />
                </div>
            </div>
            ...
            <div class="input mt-3 @if ( $facturation_steps != 2 ) d-none @endif ">
              <div class="alert alert-success">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <input wire:model="code" type="text" id="normalInput" placeholder="******" @if ( $facturation_steps > 2 ) disabled @endif />
                </div>
                @error('code')
            ...
            <div class="@if ( $facturation_steps < 3 ) d-none @endif ">
              ...
              <div wire:click="send_validation()" class="email-btn mt-3 @if ( $facturation_steps  != 1 ) d-none @endif ">
                Envoyez-moi le code
              </div>
              ...
              <div wire:click="validate_code()" class="email-btn mt-3 @if ( $facturation_steps != 2 ) d-none @endif ">
                Validez le code
              </div>
              ...
              <div wire:click="finish_facturation()" class="email-btn mt-3 @if ( $facturation_steps != 3 ) d-none @endif ">
                Suivant
              </div>
          ...
          <div class="step-heading bg-component-white mb-3 @if ( $order->facturer == true && $order->liviser == false ) @else lock-step @endif">
            <div class="d-flex align-items-center justify-content-center gap-3">
          ...
          <div class="step-inputs bg-component-white mb-3 kamas-settings w-100 @if ( $order->facturer == true && $order->liviser == false ) @else d-none @endif">
          ...
          <div class="step-inputs bg-component-white">
            @if ( $order->liviser == true && $order->order_completed == false )
              <div class="alert alert-success ">
