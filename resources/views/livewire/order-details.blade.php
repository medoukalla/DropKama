    ...
    <div class="container">
        <div class="row" wire:poll.keep-alive>
                ...
                <div class="product-line bg-component-white sticky-top">
                    <div class="line">
                        <div class="h-step active">
                            <div class="i-step">
                                <img src="{{ asset('frontend/images/svg/checked.svg') }}" alt="" height="30"
                                    class="ready">
                            </div>
                            <div class="t-step">
            ...
            <div class="col-12 col-md-6 d-flex flex-column">
                ...
                <div
                    class="step-heading bg-component-white mb-3 @if ($order->payment_verified == true && $order->facturer == false) @else lock-step @endif">
                    <div class="d-flex align-items-center justify-content-center gap-3">
                ...
                <div
                    class="step-inputs bg-component-white mb-3 kamas-settings w-100 @if ($order->payment_verified == true && $order->facturer == false) @else d-none @endif">
                ...
                <div
                    class="step-heading bg-component-white mb-3 @if ($order->facturer == true && $order->liviser == false) @else lock-step @endif">
                    <div class="d-flex align-items-center justify-content-center gap-3">
                ...
                <div
                    class="step-inputs bg-component-white mb-3 kamas-settings w-100 @if ($order->facturer == true && $order->liviser == false) @else d-none @endif">
                ...
                <div class="step-inputs bg-component-white">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3 gap-3">
                        <div class="info-component">{{ $order->server->name }} {{ $order->quantity }} M pour :
