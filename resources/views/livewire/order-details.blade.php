    ...
    <div class="container">
        <div class="row" wire:poll.keep-alive>
            ...
            <div class="col-12 col-md-6 d-flex flex-column">
                ...
                <!-- Question -->
                <div
                    class="bg-component-white mb-3 @if (!is_null($order->deleted_at)) d-none @endif @if (($order->payed == true && $order->payment_verified == false) || !is_null($order->deleted_at)) @else d-none @endif">
                ...
                <div
                    ...
                    <div class="input mt-0 @if ($facturation_steps > 2) d-none @endif">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <input wire:model.defer="email" type="email" id="normalInput"
                                value="youssef@gmail.com" disabled />
                        </div>
                    </div>
                ...
                <div class="step-inputs bg-component-white">
                    @if (!is_null($order->deleted_at))
                        <div class="alert alert-danger ">
                            Nous regrettons de vous informer que votre commande récente a été rejetée. N'hésitez pas à
                            passer une nouvelle commande à votre convenance. Si vous avez besoin d'aide, nous sommes là
                            pour vous assister.
                        </div>
                    ...
                    @elseif ($order->order_completed == true)
                        <div class="alert alert-success ">
                            Nous avons le plaisir de vous informer que votre commande a été remplie et complétée avec
                            succès. Merci d'avoir choisi nos services. Si vous avez des questions ou besoin d'aide
