<div>
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">User / profile
      </h4>
      <div class="row">
        <!-- User Sidebar -->
            ...
            <div class="card-body">
              <div class="user-avatar-section">
                <div class=" d-flex align-items-center flex-column">
                  <img class="img-fluid rounded mb-3 pt-1 mt-4" src="../../assets/img/avatars/1.png" height="100" width="100" alt="User avatar" />
              ...
              flex-wrap mt-3 pt-3 pb-4 border-bottom">
                <div class="d-flex align-items-start me-4 mt-3 gap-2">
                  ...
                  <div>
                    <p class="mb-0 fw-medium">123.000$</p>
