...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row mb-5">
            <div class="card bg-transparent shadow-none my-6 border-0 mb-5">
                <div class="card-body row p-0 pb-6 g-6">
                  <div class="col-12 ">
                    <h5 class="mb-2">Content de te revoir,<span class="h4"> {{ Auth::user()->name }} 👋🏻</span></h5>
                    <div class="col-12">

                        @if ( Auth::user()->role->id == 2 )
                            <p>
                                Nous sommes ravis de vous accueillir parmi nous. Ce tableau de bord est conçu pour vous offrir des informations en temps réel et un accès facile à tous les outils et informations essentiels.
                            </p>
                        @else
                            <p>Vos progrès cette semaine sont impressionnants. Continuons ainsi et obtenons de nombreuses récompenses en termes de revenus!</p>
                            <p>Vous avez du travail à faire</p>
                        @endif
                    ...
                    @if ( Auth::user()->role->id != 2 )    
                        ...
                        <div class="d-flex align-items-center gap-4 me-6 me-sm-0">
                            ...
                            <p class="mb-0 fw-medium">Commandes en attente</p>
                            <h4 class="text-primary mb-0">{{ $total_orders_waiting }}</h4>
                            </div>
                        </div>
                        <div class="d-flex align-items-center gap-4">
                            ...
                            <div class="content-right">
                            <p class="mb-0 fw-medium">Ventes en attente</p>
                            <h4 class="text-info mb-0">{{ $total_offers_waiting }}</h4>
                            </div>
                        </div>
                        <div class="d-flex align-items-center gap-4">
                            <div class="avatar avatar-lg">
                            <div class="avatar-initial bg-label-warning rounded">
                                <div>
                                    <i class="ti ti-arrows-exchange ti-lg"></i>
                                </div>
                            </div>
                            </div>
                            <div class="content-right">
                            <p class="mb-0 fw-medium">Échange  en attente</p>
                            <h4 class="text-warning mb-0">{{ $total_echange_waiting }}</h4>
                            </div>
                        </div>
                        </div>
                    @endif
                    ...
                    <div class="card h-100">
                        <div class="card-header pb-0 d-flex justify-content-between">
                            <div class="card-title mb-0">
                                <h5 class="mb-1">Commandes terminées</h5>
                                <p class="card-subtitle">Total des commandes passées</p>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row gap-4 gap-sm-0">
                                    <div class="col-12 col-sm-4">
                                        <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <h6 class="mb-0 fw-normal">Achat</h6>
                                        </div>
                                        <h4 class="my-2">{{ $total_orders_completed }} commandes</h4>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="d-flex gap-2 align-items-center">
                                            <div class="badge rounded bg-label-info p-1">
                                                <i class="ti ti-gift ti-sm"></i>
                                            </div>
                                            <h6 class="mb-0 fw-normal">Vendre</h6>
                                        </div>
                                        <h4 class="my-2">{{ $total_offers_completed }} ventes</h4>
                                        <div class="progress w-75" style="height:4px">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="d-flex gap-2 align-items-center">
                                            <div class="badge rounded bg-label-danger p-1">
                                                <i class="ti ti-arrows-exchange ti-sm"></i>
                                            </div>
                                            <h6 class="mb-0 fw-normal">Echange</h6>
                                        </div>
                                        <h4 class="my-2">{{ $total_echange_completed }} échanges</h4>
                                        <div class="progress w-75" style="height:4px">
                    ...
                    <div class="card">
                        ...
                        <div class="card-datatable table-responsive">
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                <div class="row">
                                    <div class="card-title m-0 me-2 py-3 px-4 ">
                                        <h5 class="mb-1">Les commandes</h5>
                                        <p class="card-subtitle">Dernières commandes sur la plateforme</p>
                                    </div>
                                </div>
                                <table class="table table-sm datatable-invoice border-top dataTable no-footer dtr-column"
                                    id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="width: 922px;">
                                    <thead>
                                        <tr>
                                            
                                            <th class="sorting_disabled" tabindex="0"  rowspan="1"
                                                colspan="1" style="width: 97px;">Ref</th>
                                            <th class="sorting_disabled" tabindex="0"  rowspan="1"
                                                colspan="1" style="width: 104px;">Quantité</th>
                                            <th class="sorting_disabled" tabindex="0"  rowspan="1"
                                                colspan="1" style="width: 99px;">Total</th>
                                            <th class="sorting_disabled" tabindex="0"  rowspan="1"
                                                colspan="1" style="width: 160px;" >Date</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ( $last_orders as $order )
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td><a href="app-invoice-preview.html">{{ $order->reference }}</a></td>
                                                <td>
                                                    {{ $order->quantity / 1 }} M
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="{{ route('voyager.orders.index') }}" class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill" aria-label="Preview" >
